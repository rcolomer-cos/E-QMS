...
IF NOT EXISTS (SELECT * FROM DatabaseVersion WHERE version = '1.0.18' AND scriptName = '08_Attachments.sql')
BEGIN
    ...
    VALUES (
        ...
        '08_Attachments.sql',
        'SUCCESS',
        'Attachments table supports secure file storage with polymorphic relationships to various entities'
    );
END
GO
