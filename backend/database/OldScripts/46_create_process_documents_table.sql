...
IF NOT EXISTS (SELECT * FROM DatabaseVersion WHERE version = '1.0.46' AND scriptName = '46_create_process_documents_table.sql')
BEGIN
    INSERT INTO DatabaseVersion (version, description, scriptName, status, notes)
    VALUES (
        '1.0.46',
        'Create ProcessDocuments link table for filtering documents by process',
        '46_create_process_documents_table.sql',
        'SUCCESS',
