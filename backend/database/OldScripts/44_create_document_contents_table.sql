...
IF NOT EXISTS (SELECT * FROM DatabaseVersion WHERE version = '1.0.44' AND scriptName = '44_create_document_contents_table.sql')
BEGIN
    INSERT INTO DatabaseVersion (version, description, scriptName, status, notes)
    VALUES (
        '1.0.44',
        'Create DocumentContents table to store rich text content and support autosave',
        '44_create_document_contents_table.sql',
        'SUCCESS',
